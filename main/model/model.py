...
class GINEncoder(nn.Module):
    ...
    def __init__(self, num_layers, num_mlp_layers, input_dim, hidden_dim, output_dim, 
                 output_dim_diffusion, final_dropout, learn_eps, graph_pooling_type,
        ...
        self.linear_out_mu = nn.Linear(output_dim, output_dim_diffusion)
        self.linear_out_logvar = nn.Linear(output_dim, output_dim_diffusion)
...
class DisseminationPropagate(nn.Module):
    def __init__(self, prob_matrix, niter):
        super(DisseminationPropagate, self).__init__()
