...
class InverseModel(nn.Module):
    def __init__(self, diffusion_model: nn.Module, gnn_model: nn.Module, propagate: nn.Module):
    ...
    def forward(self, input_pair, seed_vec, adj):
        ...
        seed_hat, mean, log_var = self.diffusion_model(input_pair, adj)
...
class ForwardModel(nn.Module):
    ...
    def forward(self, seed_vec):
        ...
        #seed_hat, mean, log_var = self.diffusion_model(input_pair)
